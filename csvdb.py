...
class DefectDb:
    ...
    def save_db(self, filename=None, path=None, date_stamp=True, as_backup=False):
    ...
    def delete_rows_where(self, col_name, value):
        """
    ...
    def insert_row(self, defect_data):
        ...
        """
        # defect = pd.DataFrame({
        #     'panel_id': defect_data[0],
        #     'location': defect_data[1],
        #     'defect_type': defect_data[2],
        #     'cause': defect_data[3],
        #     'origin': defect_data[4],
        #     'uid': defect_data[5]
        # })
        # self._data.append(defect, ignore_index=True)
        self._data.loc[len(self._data.index)] = defect_data

    # TODO: efficiently implement
